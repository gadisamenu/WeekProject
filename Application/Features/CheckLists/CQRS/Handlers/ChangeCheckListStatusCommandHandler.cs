...
{
    public class ChangeCheckListStatusCommandHandler : IRequestHandler<ChangeCheckListStatusCommand, Unit>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public ChangeCheckListStatusCommandHandler(IUnitOfWork UnitOfWork, IMapper Mapper)
        {
            _unitOfWork = UnitOfWork;

            _mapper = Mapper;
        }
        public async Task<Unit> Handle(ChangeCheckListStatusCommand request, CancellationToken cancellationToken)
        {
            var validator = new ChangeCheckListStatusDtoValidator();
